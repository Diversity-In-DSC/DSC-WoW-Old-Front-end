...
import logo from "../assets/dscwowF5F5F5.gif"
...
const BadgeModule = () => {
    ...
    const getCroppedImg = () => {
        ...
        toast.success("psst, your badge is ready to download ", { position: "top-right", autoClose: 3000 })
    };
            ...
            <div className="main-container">
                ...
                <div className="input-panel">
                    ...
                    <div className="input">
                        ...
                        <span>
                            {success && <button className="button" onClick={refreshPage}>New Image</button>}
                            {
                                !success && <button className="button" onClick={uploadImage}>Upload Image</button>
                            }
              ...
              Build with ❤️ by DSC WOW Team
                ...
                <div className="preview-panel">
                    ...
                    <canvas id="badge-canvas" width={canvasDim.width} height={canvasDim.height}></canvas>
                    {file && (
                        <img
                            src={file}
                            alt="temp"
                    ...
                    {success && <button className="button adjust" onClick={adjust}>Adjust Crop</button>}
                    {success &&
